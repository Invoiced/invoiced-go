...
type ChargeRequest struct {
	...
	Splits            []ChargePaymentSplit `json:"splits,omitempty"`              //Required, contains payment application, i.e. [{“type”: “invoice”, “invoice”: 1234, “amount”: 400.00}]
}

type ChargePaymentSplit struct {
